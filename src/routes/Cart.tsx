    ...
    <Layout>
      ...
      <div className="w-full flex flex-col items-center md:flex-row md:gap-x-16 lg:gap-x-16  md:px-8 lg:px-32 box-border ">
        <div className="">
          <div className="w-full py-4 space-y-4">
            <div className="max-w-[250px] mx-auto">
              <img src={plainBelgain} alt="" className="rounded-md" />
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex">
            <Icon icon="ic:round-star" className="text-yellow-400 text-3xl" />
            <Icon icon="ic:round-star" className="text-yellow-400 text-3xl" />
            <Icon icon="ic:round-star" className="text-yellow-400 text-3xl" />
            <Icon icon="ic:round-star" className="text-black text-3xl" />
            <Icon icon="ic:round-star" className="text-black text-3xl" />
          </div>
          ...
          <div>
            <p className="text-sm">
              <span className="font-bold underline">Shipping</span> calculated
              at checkout
            </p>
          </div>
          <div>
          ...
          <div className="flex items-center gap-x-4">
            <span className="text-black bg-pri rounded-md px-4 py-2 text-sm">
              Box of 4
            </span>
            <span className="text-black bg-pri rounded-md px-4 py-2 text-sm">
              Box of 4
          ...
          <div className="flex items-center gap-x-4">
            ...
            <button
              ...
              className="text-xl text-black bg-pri px-4 py-2 rounded-lg border-2 border-black"
            >
              Checkout
            </button>
          </div>
          <div>
            <h4 className=" text-black font-bold border-b border-black ">
              STORAGE
            </h4>
            <p className="text-sm">
              Waffles contain no preservatives Store for up to 1 week in an air
              tight container in a fridge or freezer
            </p>
          </div>
          <div>
            <h4 className=" text-black font-bold border-b border-black ">
